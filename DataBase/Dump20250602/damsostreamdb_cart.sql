...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`idCart`),
  KEY `idCli` (`idCli`),
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`idCli`) REFERENCES `user` (`idCli`)
...
INSERT INTO `cart` VALUES (2,2,40.00),(3,3,NULL),(8,8,NULL),(9,9,NULL),(10,10,NULL),(13,13,NULL),(14,14,NULL);
...
-- Dump completed on 2025-06-02 11:21:25
